<script>
  ...
  export default {
    ...
    mounted() {
      ...
      import(`!raw-loader!./component.html`).then( result => this.contentHtml = result.default)
      import(`!raw-loader!./component.css`).then( result => this.contenCss = result.default)
      import(`!raw-loader!./component.js`).then( result =>  { 
